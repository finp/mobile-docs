...
include::_partials/keycloak/provisioning-the-idm.adoc[leveloffset=+2,tags={include-tags}]
// end::excludeDownstream[]
include::_partials/keycloak/binding-an-app-to-a-service.adoc[leveloffset=+2,tags={include-tags}]
include::_partials/keycloak/configuring-the-service.adoc[leveloffset=+2,tags={include-tags}]
== Configuring your development environment for the {keycloak-service} Service
include::_partials/keycloak/downloading-configuration-file.adoc[leveloffset=+2,tags={include-tags}]
include::_partials/keycloak/setting-up-the-idm-sdk.adoc[leveloffset=+2,tags={include-tags}]
...
include::_partials/keycloak/implementing-authentication.adoc[leveloffset=+2,tags={include-tags}]
include::_partials/keycloak/refreshing-the-authentication-token.adoc[leveloffset=+2,tags={include-tags}]
include::_partials/keycloak/adding-log-out-option.adoc[leveloffset=+2,tags={include-tags}]
include::_partials/keycloak/authenticating-with-a-back-end-service.adoc[leveloffset=+2,tags=!excludeUpstream,tags={include-tags}]

include::_partials/keycloak/adding-access-control.adoc[leveloffset=2,tags={include-tags}]

[[adding-sso-to-your-mobile-app]]
== Adding SSO to your Mobile App
// include::_partials/keycloak/getting-started-with-sso.adoc[leveloffset=+2]
include::_partials/keycloak/using-sso.adoc[leveloffset=+2,tags={include-tags}]

// tag::excludeDownstream[]
[[monitoring]]
// start metrics/monitoring-keycloak.adoc[leveloffset=+1]
include::_partials/metrics/monitoring-keycloak.adoc[leveloffset=2,tags={include-tags}]
// end::excludeDownstream[]
